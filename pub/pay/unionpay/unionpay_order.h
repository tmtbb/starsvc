...
// Author: Paco.
#ifndef PUB_PAY_UNIONPAY_WX_ORDER_H_
#define PUB_PAY_UNIONPAY_WX_ORDER_H_
...
//  sign=MD5(stringSignTemp).toUpperCase()="9A0A8659F005D6984697E2CA0A9CF3B7"
 ...
 private:
  ...
  //static const char* biz_type_;
  //交易子类 固定值01
  //static const char* txn_sub_type_;

  //商户号
  static const char* mer_id_;
  //商户订单号
