...
bool RecordDB::OnGetStarInfo(std::map<std::string,star_logic::StarInfo>& map) {
...
bool RecordDB::OnUpdateTradesPosition(star_logic::TradesPosition& trades_position) {
    ...
    LOG_DEBUG(" ________________________________________________________________ ");
    LOG_DEBUG(" ________________________________________________________________ ");
    LOG_DEBUG(" ________________________________________________________________ ");
    LOG_DEBUG2("_________________________________ [%s]_____", sql.c_str());
    LOG_DEBUG(" ________________________________________________________________ ");
    LOG_DEBUG(" ________________________________________________________________ ");
    LOG_DEBUG(" ________________________________________________________________ ");
    return true;
...
void RecordDB::CallGetStarInfo(void* param, base_logic::Value* value) {
  base_logic::DictionaryValue *dict = (base_logic::DictionaryValue *) (value);
  base_logic::ListValue *list = new base_logic::ListValue();
  base_storage::DBStorageEngine *engine =
      (base_storage::DBStorageEngine *) (param);
