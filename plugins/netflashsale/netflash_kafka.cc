...
#include "netflashsale/netflash_kafka.h"
#include "basic/radom_in.h"
#include "logic/logic_comm.h"

namespace netflash_logic {

NetflashKafka::NetflashKafka(config::FileConfig* config) {
  /*
...
NetflashKafka::NetflashKafka(base::ConnAddr& addr) {
...
NetflashKafka::~NetflashKafka() {
  kafka_producer_.Close();
}

bool NetflashKafka::SetNetflashOrder(star_logic::TradesOrder& order) {
